...
/* RHXS256 */
const uint8_t RHX_CSHAKE256_INFO[7] = { 82, 72, 88, 83, 50, 53, 54 };
/* RHXS512 */
const uint8_t RHX_CSHAKE512_INFO[7] = { 82, 72, 88, 83, 53, 49, 50 };
/* RHXH256 */
const uint8_t RHX_HKDF256_INFO[7] = { 82, 72, 88, 72, 50, 53, 54 };
/* RHXH512 */
const uint8_t RHX_HKDF512_INFO[7] = { 82, 72, 88, 72, 53, 49, 50 };
...
/* rijndael s-box, rcon, and pre-multiplication constant tables */
...
static void decrypt_block(rhx_state* state, uint8_t* output, const uint8_t* input)
{
	const size_t RNDCNT = state->rndkeylen - 4;
	uint32_t x0;
	uint32_t x1;
	uint32_t x2;
	uint32_t x3;
	...
	/* round 0 */
	x0 = load_be32(input, 0) ^ state->roundkeys[0];
	x1 = load_be32(input, 4) ^ state->roundkeys[1];
	x2 = load_be32(input, 8) ^ state->roundkeys[2];
	x3 = load_be32(input, 12) ^ state->roundkeys[3];
	y0 = it_0[(x0 >> 24)] ^ it_1[(uint8_t)(x3 >> 16)] ^ it_2[(uint8_t)(x2 >> 8)] ^ it_3[(uint8_t)x1] ^ state->roundkeys[4];
	y1 = it_0[(x1 >> 24)] ^ it_1[(uint8_t)(x0 >> 16)] ^ it_2[(uint8_t)(x3 >> 8)] ^ it_3[(uint8_t)x2] ^ state->roundkeys[5];
	y2 = it_0[(x2 >> 24)] ^ it_1[(uint8_t)(x1 >> 16)] ^ it_2[(uint8_t)(x0 >> 8)] ^ it_3[(uint8_t)x3] ^ state->roundkeys[6];
	y3 = it_0[(x3 >> 24)] ^ it_1[(uint8_t)(x2 >> 16)] ^ it_2[(uint8_t)(x1 >> 8)] ^ it_3[(uint8_t)x0] ^ state->roundkeys[7];
	...
	while (kctr != RNDCNT)
	{
		x0 = it_0[(y0 >> 24)] ^ it_1[(uint8_t)(y3 >> 16)] ^ it_2[(uint8_t)(y2 >> 8)] ^ it_3[(uint8_t)y1] ^ state->roundkeys[kctr];
		x1 = it_0[(y1 >> 24)] ^ it_1[(uint8_t)(y0 >> 16)] ^ it_2[(uint8_t)(y3 >> 8)] ^ it_3[(uint8_t)y2] ^ state->roundkeys[kctr + 1];
		x2 = it_0[(y2 >> 24)] ^ it_1[(uint8_t)(y1 >> 16)] ^ it_2[(uint8_t)(y0 >> 8)] ^ it_3[(uint8_t)y3] ^ state->roundkeys[kctr + 2];
		x3 = it_0[(y3 >> 24)] ^ it_1[(uint8_t)(y2 >> 16)] ^ it_2[(uint8_t)(y1 >> 8)] ^ it_3[(uint8_t)y0] ^ state->roundkeys[kctr + 3];
		y0 = it_0[(x0 >> 24)] ^ it_1[(uint8_t)(x3 >> 16)] ^ it_2[(uint8_t)(x2 >> 8)] ^ it_3[(uint8_t)x1] ^ state->roundkeys[kctr + 4];
		y1 = it_0[(x1 >> 24)] ^ it_1[(uint8_t)(x0 >> 16)] ^ it_2[(uint8_t)(x3 >> 8)] ^ it_3[(uint8_t)x2] ^ state->roundkeys[kctr + 5];
		y2 = it_0[(x2 >> 24)] ^ it_1[(uint8_t)(x1 >> 16)] ^ it_2[(uint8_t)(x0 >> 8)] ^ it_3[(uint8_t)x3] ^ state->roundkeys[kctr + 6];
		y3 = it_0[(x3 >> 24)] ^ it_1[(uint8_t)(x2 >> 16)] ^ it_2[(uint8_t)(x1 >> 8)] ^ it_3[(uint8_t)x0] ^ state->roundkeys[kctr + 7];
		kctr += 8;
	}

	/* final round */
	output[0] = (uint8_t)(is_box[(uint8_t)(y0 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[1] = (uint8_t)(is_box[(uint8_t)(y3 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[2] = (uint8_t)(is_box[(uint8_t)(y2 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[3] = (uint8_t)(is_box[(uint8_t)y1] ^ (uint8_t)state->roundkeys[kctr]);
	++kctr;
	output[4] = (uint8_t)(is_box[(uint8_t)(y1 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[5] = (uint8_t)(is_box[(uint8_t)(y0 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[6] = (uint8_t)(is_box[(uint8_t)(y3 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[7] = (uint8_t)(is_box[(uint8_t)y2] ^ (uint8_t)state->roundkeys[kctr]);
	++kctr;
	output[8] = (uint8_t)(is_box[(uint8_t)(y2 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[9] = (uint8_t)(is_box[(uint8_t)(y1 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[10] = (uint8_t)(is_box[(uint8_t)(y0 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[11] = (uint8_t)(is_box[(uint8_t)y3] ^ (uint8_t)(state->roundkeys[kctr]));
	++kctr;
	output[12] = (uint8_t)(is_box[(uint8_t)(y3 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[13] = (uint8_t)(is_box[(uint8_t)(y2 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[14] = (uint8_t)(is_box[(uint8_t)(y1 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[15] = (uint8_t)(is_box[(uint8_t)y0] ^ (uint8_t)state->roundkeys[kctr]);
}
...
static void encrypt_block(rhx_state* state, uint8_t* output, const uint8_t* input)
{
	...
	x2 = load_be32(input, 8) ^ state->roundkeys[2];
	x3 = load_be32(input, 12) ^ state->roundkeys[3];
	y0 = t_0[(uint8_t)(x0 >> 24)] ^ t_1[(uint8_t)(x1 >> 16)] ^ t_2[(uint8_t)(x2 >> 8)] ^ t_3[(uint8_t)x3] ^ state->roundkeys[4];
	y1 = t_0[(uint8_t)(x1 >> 24)] ^ t_1[(uint8_t)(x2 >> 16)] ^ t_2[(uint8_t)(x3 >> 8)] ^ t_3[(uint8_t)x0] ^ state->roundkeys[5];
	y2 = t_0[(uint8_t)(x2 >> 24)] ^ t_1[(uint8_t)(x3 >> 16)] ^ t_2[(uint8_t)(x0 >> 8)] ^ t_3[(uint8_t)x1] ^ state->roundkeys[6];
	y3 = t_0[(uint8_t)(x3 >> 24)] ^ t_1[(uint8_t)(x0 >> 16)] ^ t_2[(uint8_t)(x1 >> 8)] ^ t_3[(uint8_t)x2] ^ state->roundkeys[7];
	...
	while (kctr != RNDCNT)
	{
		x0 = t_0[(uint8_t)(y0 >> 24)] ^ t_1[(uint8_t)(y1 >> 16)] ^ t_2[(uint8_t)(y2 >> 8)] ^ t_3[(uint8_t)y3] ^ state->roundkeys[kctr];
		x1 = t_0[(uint8_t)(y1 >> 24)] ^ t_1[(uint8_t)(y2 >> 16)] ^ t_2[(uint8_t)(y3 >> 8)] ^ t_3[(uint8_t)y0] ^ state->roundkeys[kctr + 1];
		x2 = t_0[(uint8_t)(y2 >> 24)] ^ t_1[(uint8_t)(y3 >> 16)] ^ t_2[(uint8_t)(y0 >> 8)] ^ t_3[(uint8_t)y1] ^ state->roundkeys[kctr + 2];
		x3 = t_0[(uint8_t)(y3 >> 24)] ^ t_1[(uint8_t)(y0 >> 16)] ^ t_2[(uint8_t)(y1 >> 8)] ^ t_3[(uint8_t)y2] ^ state->roundkeys[kctr + 3];
		y0 = t_0[(uint8_t)(x0 >> 24)] ^ t_1[(uint8_t)(x1 >> 16)] ^ t_2[(uint8_t)(x2 >> 8)] ^ t_3[(uint8_t)x3] ^ state->roundkeys[kctr + 4];
		y1 = t_0[(uint8_t)(x1 >> 24)] ^ t_1[(uint8_t)(x2 >> 16)] ^ t_2[(uint8_t)(x3 >> 8)] ^ t_3[(uint8_t)x0] ^ state->roundkeys[kctr + 5];
		y2 = t_0[(uint8_t)(x2 >> 24)] ^ t_1[(uint8_t)(x3 >> 16)] ^ t_2[(uint8_t)(x0 >> 8)] ^ t_3[(uint8_t)x1] ^ state->roundkeys[kctr + 6];
		y3 = t_0[(uint8_t)(x3 >> 24)] ^ t_1[(uint8_t)(x0 >> 16)] ^ t_2[(uint8_t)(x1 >> 8)] ^ t_3[(uint8_t)x2] ^ state->roundkeys[kctr + 7];
		kctr += 8;
	}

	/* final round */
	output[0] = (uint8_t)(s_box[(uint8_t)(y0 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[1] = (uint8_t)(s_box[(uint8_t)(y1 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[2] = (uint8_t)(s_box[(uint8_t)(y2 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[3] = (uint8_t)(s_box[(uint8_t)(y3)] ^ (uint8_t)(state->roundkeys[kctr]));
	++kctr;
	output[4] = (uint8_t)(s_box[(uint8_t)(y1 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[5] = (uint8_t)(s_box[(uint8_t)(y2 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[6] = (uint8_t)(s_box[(uint8_t)(y3 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[7] = (uint8_t)(s_box[(uint8_t)(y0)] ^ (uint8_t)(state->roundkeys[kctr]));
	++kctr;
	output[8] = (uint8_t)(s_box[(uint8_t)(y2 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[9] = (uint8_t)(s_box[(uint8_t)(y3 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[10] = (uint8_t)(s_box[(uint8_t)(y0 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[11] = (uint8_t)(s_box[(uint8_t)(y1)] ^ (uint8_t)(state->roundkeys[kctr]));
	++kctr;
	output[12] = (uint8_t)(s_box[(uint8_t)(y3 >> 24)] ^ (uint8_t)(state->roundkeys[kctr] >> 24));
	output[13] = (uint8_t)(s_box[(uint8_t)(y0 >> 16)] ^ (uint8_t)(state->roundkeys[kctr] >> 16));
	output[14] = (uint8_t)(s_box[(uint8_t)(y1 >> 8)] ^ (uint8_t)(state->roundkeys[kctr] >> 8));
	output[15] = (uint8_t)(s_box[(uint8_t)(y2)] ^ (uint8_t)(state->roundkeys[kctr]));
}
...
#if defined(RHX_PREFETCH_TABLES)
...
void rhx_cbc_decrypt(rhx_state* state, uint8_t* output, uint8_t* iv, const uint8_t* input)
{
	...
	memcpy(&tmpv[0], &input[0], RHX_BLOCK_SIZE);
	...
	memcpy(&iv[0], &tmpv[0], RHX_BLOCK_SIZE);
}
...
void rhx_cbc_encrypt(rhx_state* state, uint8_t* output, uint8_t* iv, const uint8_t* input)
{
	...
	memcpy(&iv[0], &output[0], RHX_BLOCK_SIZE);
}

void rhx_ctr_transform(rhx_state* state, uint8_t* output, uint8_t* nonce, const uint8_t* input, size_t inplen)
{
	/* null or illegal state values */
	assert(state->roundkeys != NULL);
	assert(state->rndkeylen != 0);
	...
	while (inplen >= RHX_BLOCK_SIZE)
	{
		encrypt_block(state, output + poff, nonce);
	...
	if (inplen != 0)
	{
		...
		encrypt_block(state, tmpb, nonce);

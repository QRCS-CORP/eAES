...
bool cshake_simple_128_kat_test()
{
	uint8_t exp0[512] = { 0 };
	uint8_t exp1600[512] = { 0 };
	uint8_t hash[CSHAKE_128_RATE * 4] = { 0 };
	uint8_t msg0[1] = { 0 };
	uint8_t msg1600[200] = { 0 };
	uint8_t output[512] = { 0 };
	shake_state state;
	...
	hex_to_bin("076CB8EE5DE4E1FFCE8680A70C5A1635BCA6C310A6BC82C67ABBB7C4B1386514"
		...
		"76BE60C19132F4FFAAD304FD3647A64742F361E4E94EFAA9571C51B676D23198", exp0, sizeof(exp0));
	...
	hex_to_bin("6B914E9D716F1CD47B83CCF491565DD2BF6860C4CF33A4CBB28D44DB6CBFF703"
		...
		"C2E9CAF11BC685F558CD5C324C7FFDAE8812730741BAD2EFBC3268DCC7748125", exp1600, sizeof(exp1600));
	...
	clear8(output, sizeof(output));
	cshake128_simple(output, sizeof(output), 0x0001U, msg0, 0);
	...
	clear8(output, sizeof(output));
	cshake128_simple(output, sizeof(output), 0x0001U, msg1600, sizeof(msg1600));
	...
	clear8(hash, sizeof(hash));
	clear64(state.state, SHAKE_STATE_SIZE);
	cshake128_simple_initialize(&state, 0x0001U, msg1600, sizeof(msg1600));
...
bool cshake_simple_256_kat_test()
{
	uint8_t exp0[512] = { 0 };
	uint8_t exp1600[512] = { 0 };
	uint8_t hash[CSHAKE_256_RATE * 4] = { 0 };
	uint8_t msg0[1] = { 0 };
	uint8_t msg1600[200] = { 0 };
	uint8_t output[512] = { 0 };
	shake_state state;
	...
	hex_to_bin("2D706C4E24701AF4950286EA2C5491C92C1A2519ECE7B3326B1A6F25A86031A3"
		...
		"8C2210AF8858780CE045EE6FBA8DF79926991BE12D9E39536D9091254E1DF781", exp0, sizeof(exp0));
	...
	hex_to_bin("E53E39A5847B628D4FBDF0A08499088DC0ED961C8E279B0D67CE58DC69CEAAE5"
		...
		"96CDF5212B3B697C332196487AAA2433F72D2B8EA018E9DBC9658D8B659848E8", exp1600, sizeof(exp1600));
	...
	clear8(output, sizeof(output));
	cshake256_simple(output, sizeof(output), 0x0001U, msg0, 0);
	...
	clear8(output, sizeof(output));
	cshake256_simple(output, sizeof(output), 0x0001U, msg1600, sizeof(msg1600));
	...
	clear8(hash, CSHAKE_256_RATE * 4);
	clear64(state.state, SHAKE_STATE_SIZE);
	cshake256_simple_initialize(&state, 1, msg1600, sizeof(msg1600));
